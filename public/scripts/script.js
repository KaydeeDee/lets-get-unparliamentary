...
$(document).ready(function () {
    ...
    var insultGenerator = function insultGenerator(userName) {

        // random number generator

        var randomIndexOne = Math.floor(Math.random() * arrayOne.length);
        var randomIndexTwo = Math.floor(Math.random() * arrayTwo.length);
